(function ($, Drupal, drupalSettings) {
    ...
    function init() {
        if(!initialized) {
            ...
            const circle_data = [[1090, 250], [867, 277], [648, 227]];
            circle_data.forEach(c => {
                var circle = drittePhaseKonvergentGroup.append('circle')
                .attr('cx', function() {return c[0]})
                .attr('cy', function() {return c[1]})
                .attr('r', 8)
                .attr('stroke', 'black')
                .attr('fill', '#69a3b2')
