...
class ModuleConfigureForm extends FormBase {
  ...
  public function getFormId() {
    return 'xnavi_module_configure_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    $form['description'] = [
      '#type' => 'item',
      '#markup' => $this->t('This is a list of modules that are supported by x.Navi, but not enabled by default.'),
    ];
    ...
    $xnavi_features = array_filter($modules, function (Extension $module) {
      return $module->info['package'] === 'x.Navi Optional';
    });

    foreach ($xnavi_features as $id => $module) {
    ...
    $form['#attached']['library'][] = 'xnavi/module.configure.form';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    if ($operations) {
      ...
      if (InstallerKernel::installationAttempted()) {
        ...
        $buildInfo['args'][0]['xnavi_install_batch'] = $batch;
