<?php return array(
    ...
    'versions' => array(
        ...
        'npm-asset/d3-collection' => array(
            'pretty_version' => '1.0.7',
            'version' => '1.0.7.0',
            'type' => 'npm-asset',
            'install_path' => __DIR__ . '/../npm-asset/d3-collection',
            'aliases' => array(),
            'reference' => NULL,
            'dev_requirement' => false,
        ),
        'npm-asset/d3-dispatch' => array(
            'pretty_version' => '1.0.6',
            'version' => '1.0.6.0',
            'type' => 'npm-asset',
            'install_path' => __DIR__ . '/../npm-asset/d3-dispatch',
            'aliases' => array(),
            'reference' => NULL,
            'dev_requirement' => false,
        ),
        'npm-asset/d3-force' => array(
            'pretty_version' => '1.2.1',
            'version' => '1.2.1.0',
            'type' => 'npm-asset',
            'install_path' => __DIR__ . '/../npm-asset/d3-force',
            'aliases' => array(),
            'reference' => NULL,
            'dev_requirement' => false,
        ),
        'npm-asset/d3-quadtree' => array(
            'pretty_version' => '1.0.7',
            'version' => '1.0.7.0',
            'type' => 'npm-asset',
            'install_path' => __DIR__ . '/../npm-asset/d3-quadtree',
            'aliases' => array(),
            'reference' => NULL,
            'dev_requirement' => false,
        ),
        'npm-asset/d3-timer' => array(
            'pretty_version' => '1.0.10',
            'version' => '1.0.10.0',
            'type' => 'npm-asset',
            'install_path' => __DIR__ . '/../npm-asset/d3-timer',
            'aliases' => array(),
            'reference' => NULL,
            'dev_requirement' => false,
        ),
        'npm-asset/vue-d3-network' => array(
            'pretty_version' => '0.1.28',
            'version' => '0.1.28.0',
            'type' => 'npm-asset',
            'install_path' => __DIR__ . '/../npm-asset/vue-d3-network',
            'aliases' => array(),
            'reference' => NULL,
            'dev_requirement' => false,
        ),
